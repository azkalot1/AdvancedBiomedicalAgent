...
def show_help() -> None:
    ...
    print("                             (agent tools include search_opentargets → Open Targets API)")
    ...
    print("  ingest --quick-prototype - Run lightweight prototype ingestion profile")
    ...
    print("  ingest --skip-hpa-rna     - Skip HPA RNA single-cell-type expression ingest")
    print("  ingest --hpa-rna-only     - Only ingest HPA RNA (standalone)")
    print("  ingest --skip-string-ppi  - Skip STRING DB PPI ingest (human)")
    print("  ingest --string-ppi-only  - Only ingest STRING PPI (standalone)")
    ...
    print("  ingest --quick-prototype - Lightweight profile (OpenFDA + Orange Book only)")
    print()
    ...
    print("  biomedagent-db ingest --quick-prototype")
    ...
    print("  biomedagent-db ingest --hpa-rna-only      # HPA RNA TSV only")
    print("  biomedagent-db ingest --string-ppi-only   # STRING PPI only")
